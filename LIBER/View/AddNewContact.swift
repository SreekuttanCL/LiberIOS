...
struct AddNewContact: View {
    ...
    var body: some View {
        VStack{
            ...
            Button(action: {
                if email.isEmail{
                    contactManager.addContactImage(uid: getUID()+email, firstName: firstName, lastName: lastName, email: email, phoneNumber: phoneNumber, image: image!)
...
struct AddNewContact_Previews: PreviewProvider {
    static var previews: some View {
        AddNewContact(showAddNewContact: .constant(false))
    }
}
